...
/**
 * Introduction to Computer Science, Ariel University, Ex3: This class
 * represents a 2D point in the plane. Do NOT change this class! It would be
 * used as is for testing.
 * 
...
public class Point2D {
	...
	/**
	 * Note: this code was updated (in v0.2) in order to follow the notion of "close
	 * shapes".
	 */
